    ...
    return (
        <div className = "header-section">
            ...
            <details>
                ...
                <p>The units of measurement used in Brazil are different than in the U.S. and Europe, often causing confusion when converting recipes. This app address this problem by enabling users to convert between different units of volume, in English or Portuguese</p>
